//The following javascript code is a standard menu toggle function that is activated when in mobile view. The function selects the menu button, labelled ".menu" and toggles the navigation overlay if clicked//
const doc = document;
